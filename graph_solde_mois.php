...
/*
$sql='SELECT (Date_comptable) dc, (solde_computed) mt ';
$sql=$sql.$_SESSION['sqlFrom'].$_SESSION['sqlWhere'];
$sql=$sql." GROUP BY EXTRACT(YEAR_MONTH FROM Date_comptable), dc, mt ";
*/
$sql="SELECT EXTRACT(YEAR_MONTH FROM Date_comptable) ym, sum(solde_computed) mt ";
$sql=$sql.$_SESSION['sqlFrom'].$_SESSION['sqlWhere'];
$sql=$sql." GROUP BY ym ";
