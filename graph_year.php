...
<?php  {
	...
	session_start();
	$Title="Montant PAR ANNEE: ";
	include_once 'dblogin.php';
	include_once 'ScanFolderCSV.php';
	
	$sql="SELECT EXTRACT(YEAR FROM Date_comptable) dc, sum(Montant) mt ";
	$sql=$sql.$_SESSION['sqlFrom'].$_SESSION['sqlWhere'];
	
	$sql=$sql." GROUP BY EXTRACT(YEAR FROM Date_comptable) ";
	//echo $sql;
...
?>
        ...
        // Set chart options  
       var options = {title: <?php { echo"'".$Title.$_SESSION['InfoLine']."'"; } ?>  ,
		      //curveType: 'function',
          width:1400,
          height:500,
